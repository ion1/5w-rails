...
tietää, mitä tehdä, kun speksissä lukee esim. {\em ''\en{When I press \dots}''}
tai {\em ''\en{Then I should see \dots}''}.

Tämän speksin ainoa testi, jonka toteuttavan koodin joudumme toteuttamaan itse,
on {\em ''\en{Then I should see a timestamp no older/newer than \dots}''}. Se
